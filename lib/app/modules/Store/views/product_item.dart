...
class _ProductItemState extends State<ProductItem> {
  ...
  _buildAgeSection(ProductDetailsModel model) {
    rxSelectedAgeSubject.sink.add(widget.data.attributes![0].optionValue![0]);
        ...
        builder: (context, snapshot) {
          return DropdownButtonHideUnderline(
            child: DropdownButton<String>(
              ...
              value: snapshot.data,
              items:
              model.attributes![0].optionValue!
                  .toSet()
                  .toList()
                  .map((String value) {
                    String v = model.attributes![0].options![widget.data.attributes![0].optionValue!.indexOf(value)];
