...
class YourbabyViews extends GetView<YourBabyController> {
  @override
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('Baby: Month',style: Theme.of(context).textTheme.bodyText1,),
                                  ...
                                  return Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text('${snapshot.data![index].name}',style: GoogleFonts.roboto(fontSize: 14,fontWeight: FontWeight.w300,color: white_color)),
                                      //  Divider(height: 5,color: Colors.transparent,),
