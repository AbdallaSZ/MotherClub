...
class _StoreViewScreenState  extends State<cart_view>{
...
*/
                Container(
                  ...
                  SizedBox(width: 10,),
                  Text("You have 2 items  in list cart",style: GoogleFonts.roboto(
                    fontSize: 13,
                    ...
                    child: FutureBuilder<List<ProductModel>>(
                      ...
                      builder: (context, snapshot) {
                        if (snapshot.hasData) {
                          ...
                          print(data);
                          return _firstSearch?  ListView.builder(
                                      ...
                                      mainAxisAlignment: MainAxisAlignment.start,
                                        ...
                                        children:[
                                         // SizedBox(height:23),
                                          Expanded(
                                            flex:2,
                                              child: Image.network('${data[index].imageslist[0].src}',height: 100,width: 155,)),
                                         // SizedBox(height:15),
                                          Expanded(
                                            flex:3,
                                            child: Column(
                                              ...
                                              Align(
                                                ...
                                                child: Text("${data[index].name}",style: GoogleFonts.roboto(
                                                  fontSize: 13,
                                                  fontStyle: FontStyle.normal,
                                                  fontWeight: FontWeight.w500,
                                                  color: Black_textColor,
                                              ...
                                              Align(
                                                alignment: Alignment.topLeft,
                                                child: Text("10 cm",style: GoogleFonts.roboto(
                                                  fontSize: 14,
                                                  fontStyle: FontStyle.normal,
                                                  fontWeight: FontWeight.w700,
                                                  color: Colors.grey,
                                              ...
                                              child: Container(
                                                  ...
                                                  child:  Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      Text('1',style: GoogleFonts.roboto(fontSize: 16,fontWeight: FontWeight.normal,color: Colors.black)),
