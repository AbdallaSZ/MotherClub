                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(Utils.labels!.week_pregnancy,style: Theme.of(context).textTheme.bodyText1,),
                                    ...
                                    child: ListView.builder(
                                        ...
                                        itemBuilder: (BuildContext context,int index){
                                          return Container(
                                            ...
                                            decoration: BoxDecoration(
                                              color: tappedIndex == index ? blue_color : Colors.transparent,
                                              border: Border.all(
                                                color: tappedIndex == index ?Colors.transparent:Colors.white24,
                                                width: 1,
                                              ),
                                              ...
                                              child: Container(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(snapshot.data![index].name,style: GoogleFonts.roboto(fontSize: deviceHeight/58,fontWeight: FontWeight.w300,color: white_color)),
                                                    //Divider(height: 5,color: Colors.transparent,),
                    ...
                    builder: (context, snapshott) {
                      ...
                      return SliverList(
                        delegate: SliverChildBuilderDelegate(
                            ...
                            return Column(
                              children: [
                                (weekSlug=="0")?Container(
                                  child: FlickVideoPlayer(
                                      flickManager: FlickManager(
                                        videoPlayerController:
                                        VideoPlayerController.network("https://mothersclub.me/wp-content/uploads/2021/01/الاسبوع-الثاني.mp4"),
                                      )
                                  ),
                                ):Container(
                                  child: FlickVideoPlayer(
                                      flickManager: FlickManager(
                                        videoPlayerController:
                                        VideoPlayerController.network(snapshott.data![index].video_link),
                                      )
                                  ),
                                ),
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Flexible(
                                                ...
                                                child: Image.asset(
                                                  'assets/images/RectangleDemo.png',fit: BoxFit.fill,)),
                                            Flexible(
                                              flex: 3,
                                                  ...
                                                  children: [
                                                    ...
                                                    Text( Utils.labels!.week+"2",
                                                            style: Theme
                                                                ...
                                                                .textTheme
                                                                .headline3):
                                                        Text(snapshott.data![index].name,
                                                        style: Theme
                                                            .of(context)
                                                            .textTheme
                                                            .headline3),
                                                    ...
                                                    (weekSlug=="0")?
                                                    Text("يتمكن 400 حيوان منوي فقط من إتمام الرحلة الشاقة والتي تستمر عشر ساعات للوصول إلى البويضة، بينما حيوان منوي واحد فقط الذي يتمكن من اختراق الغشاء الخارجي للبويضة. يكون طفلك في هذا الوقت عبارة عن كرة صغيرة من الخلايا والتي اتفق العلماء على تسميتها بالكيس الأريميّ",
