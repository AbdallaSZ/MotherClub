...
class TinvwlFormdataVariation {
  ...
  final AttributePaAge ?attributePaAge;
  ...
  factory TinvwlFormdataVariation.fromMap(Map<String, dynamic> json) => TinvwlFormdataVariation(
    attributePaAge: json["attribute_pa_age"] == null ? null : attributePaAgeValues.map![json["attribute_pa_age"]],
  );

  Map<String, dynamic> toMap() => {
    "attribute_pa_age": attributePaAge == null ? null : attributePaAgeValues.reverse![attributePaAge],
  };
}

enum AttributePaAge { THE_03_MONTHS }

final attributePaAgeValues = EnumValues({
...
enum Age { THE_03_MONTHS }

final ageValues = EnumValues({
  "0-3 Months": Age.THE_03_MONTHS
});
...
class ItemTaxData {
  ...
  factory ItemTaxData.fromJson(String str) => ItemTaxData.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory ItemTaxData.fromMap(Map<String, dynamic> json) => ItemTaxData(
    subtotal: json["subtotal"] == null ? null : Subtotal.fromMap(json["subtotal"]),
    total: json["total"] == null ? null : Subtotal.fromMap(json["total"]),
  );
...
class RemovedItem {
  ...
  factory RemovedItem.fromJson(String str) => RemovedItem.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory RemovedItem.fromMap(Map<String, dynamic> json) => RemovedItem(
    itemKey: json["item_key"] == null ? null : json["item_key"],
    id: json["id"] == null ? null : json["id"],
    name: json["name"] == null ? null : json["name"],
    title: json["title"] == null ? null : json["title"],
...
class RemovedItemTaxData {
  ...
  factory RemovedItemTaxData.fromJson(String str) => RemovedItemTaxData.fromMap(json.decode(str));
...
class Rates {
  ...
  final FreeShipping1 ?freeShipping1;
  ...
  factory Rates.fromMap(Map<String, dynamic> json) => Rates(
    freeShipping1: json["free_shipping:1"] == null ? null : FreeShipping1.fromMap(json["free_shipping:1"]),
...
class FlatRate4 {
  ...
  factory FlatRate4.fromMap(Map<String, dynamic> json) => FlatRate4(
    ...
    taxes: json["taxes"] == null ? null : Subtotal.fromMap(json["taxes"]),
    chosenMethod: json["chosen_method"] == null ? null : json["chosen_method"],
  );
...
class FreeShipping1 {
  ...
  factory FreeShipping1.fromMap(Map<String, dynamic> json) => FreeShipping1(
    key: json["key"] == null ? null : json["key"],
    methodId: json["method_id"] == null ? null : json["method_id"],
    instanceId: json["instance_id"] == null ? null : json["instance_id"],
    label: json["label"] == null ? null : json["label"],
...
class Taxes {
  ...
  factory Taxes.fromMap(Map<String, dynamic> json) => Taxes(
    aeTax1: json["AE-TAX-1"] == null ? null : AeTax1.fromMap(json["AE-TAX-1"]),
  );

  Map<String, dynamic> toMap() => {
    "AE-TAX-1": aeTax1 == null ? null : aeTax1!.toMap(),
  };
}
...
class AeTax1 {
  ...
  factory AeTax1.fromJson(String str) => AeTax1.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory AeTax1.fromMap(Map<String, dynamic> json) => AeTax1(
    name: json["name"] == null ? null : json["name"],
    price: json["price"] == null ? null : json["price"],
  );
