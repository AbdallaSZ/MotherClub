...
class _RegisterViewState extends State<RegisterView> {
              ...
              child: GestureDetector(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      CustomLogoWidget(
                          "", deviceHeight / 4, deviceWidth, context, true),
                      Container(
                        ...
                        child: Form(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(Utils.labels!.create_New_Account,
                                  style: Theme.of(context).textTheme.headline1),
                              SizedBox(width: 10),
                              Text(
                                Utils.labels!.create_new_account_to_see,
                              ...
                              EditTextwidget(Utils.labels!.username,
                              ...
                              EditTextwidget(Utils.labels!.email,
                              ...
                              EditTextwidget(Utils.labels!.password,
                              ...
                              EditTextWidget(
                                  Lable: Utils.labels!.age +
                                      " " +
                                      Utils.labels!.your_baby,
                                  context: context,
                                  IconButton:
                                      Icons.keyboard_arrow_down_outlined,
                                  textEditingController: _yourbabyController),
                              ...
                              EditTextWidget(
                                  Lable: Utils.labels!.your_Pregnancy,
                                  context: context,
                                  IconButton:
                                      Icons.keyboard_arrow_down_outlined,
                                  textEditingController: Baby_AgeController),
  ...
  void fireRegisterEvent() {
    _bloc!.add(RegisterEvent(RegisterRequestModel(
        ...
        customFieldsFirstName: _nameController.text,
