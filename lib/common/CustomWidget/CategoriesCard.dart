        ...
        child: Row(
          ...
          Flexible(
            ...
            child: Column(
              ...
              children: [
              Text('${categoriesModel.title}',style:  Theme.of(context).textTheme.headline1),
              Divider(height: 5,color: Colors.transparent,),
              Text('${categoriesModel.description}',style:  Theme.of(context).textTheme.bodyText1,maxLines: 3,),
